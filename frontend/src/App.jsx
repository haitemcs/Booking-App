...
function RoomDetails({ room, loggedIn, onBack, onLogin, onBooked }) {
  ...
  async function book(e) {
    ...
    try { await api.createOccupancy({ room: room.url, start_date: start, end_date: end }); setMessage('Booking confirmed.'); setTimeout(onBooked, 600) }
